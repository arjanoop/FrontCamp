...
var fdata, pdata = [];
let sources = [];
var url = "https://newsapi.org/v2/top-headlines?country=in&apiKey=25517c086fef47eb8e36ec453354200d";
...
arr.then((arr) => {
    ...
    M.className = 'M';
    M.setAttribute ('category-id', element.source.name);
    ...
    titles.innerHTML = element.title+"<br>";
    p1.className = "p1";
    p1.innerHTML = "Posted on "+arr.publishedAt+" //Category: Category "+element.source.name
    ;
    ...
    console.log(arr);
    // function call
    // that directly renders section taking
    // data from arr
...
//    p1.className = "p1";
//    p1.innerHTML = "Posted on "+pdata[a].date+" //Category: Category "+pdata[a].
//    ;
//    var p2 = document.createElement("p");
//    p2.className = "p2";
